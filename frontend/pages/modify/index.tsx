...
const Page = (): JSX.Element => {
    ...
    return (
        <>
            <Sticky top="0">
                <Header prefix={<Button onClick={() => router.back()} icon={<i className="xi-angle-left-min"></i>}></Button>} title="계정 정보 수정" centerTitle noMargin>
                    <Button
                        type="text"
                        onClick={() => {
                            deleteAccount()
            ...
            <Space direction="column" vAlign="flex-start" cover padding="20px 10px 200px">
                ...
                <Space direction="column" vAlign="flex-start" cover>
                    ...
                    />
                    <Button type="link" href={siteLink} target="_blank">
                        새창으로 열기
                    </Button>
                </Space>
                <Space direction="column" vAlign="flex-start" cover>
